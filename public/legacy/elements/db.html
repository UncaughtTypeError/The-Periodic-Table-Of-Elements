...
<html>
    <head>
        <!-- Title -->
        <title>Dubnium (Db) - The Periodic Table Of Elements</title>
        ...
        <link rel="canonical" href="https://periodictableofchemicalelements.com/dubnium">

        <meta name="description" content="Dubnium is a chemical element with symbol Db and atomic number 105. A transactinide element, dubnium is highly radioactive: the most stable known isotope, dubnium-268, has a half-life of just above a day.">
        <meta name="robots" content="noindex,nofollow">
        <meta property="og:locale" content="en_GB">
        <meta property="og:type" content="website">
        <meta property="og:title" content="Dubnium (Db) - The Periodic Table Of Elements">
    ...
    <div class="wrapper">
        <div class="wrapper-inner">
            <div class="card summary">
                ...
                <ul>
                    <li>Symbol: <sub>105</sub>Db</li>
                    <li>Name: dubnium</li>
                    <li>Atomic number: 105</li>
                    <li>Atomic mass: 262 u</li>
                    <li>Electron configuration: 5f146d37s2</li>
                    <li>Discovered: 1970</li>
                    <li>Discoverers: University of California, the Joint Institute for Nuclear Research</li>
                </ul>   
            </div> 
            <div class="card description">
                <p>Dubnium is a chemical element with symbol Db and atomic number 105. A transactinide element, dubnium is highly radioactive: the most stable known isotope, dubnium-268, has a half-life of just above a day. This greatly limits the extent of possible research on dubnium.</p>
                <p>Dubnium does not naturally occur on Earth and must be produced artificially. The Soviet Joint Institute for Nuclear Research (JINR) team claimed discovery in 1968, and the American University of California team did so in 1970. Both teams proposed a name for the new element and used it without waiting for formal approval; similar controversies over priority of discovery occurred with elements 102–109. Attempts to resolve the dispute continued from the late 1980s through the 1990s; criteria for discovery were suggested by the IUPAC/IUPAP Joint Working Party and claims were evaluated against those criteria. Credit for discovery of element 105 was shared between the two teams; the American team protested, but was ultimately rejected. After several rounds of negotiation, names for the new elements were chosen; the final compromise named element 105 dubnium after Dubna, the site of the JINR.</p>
            </div> 
            <div class="card overview">
                ...
                <ul>
                    ...
                    <li>Electron configuration: 5f14 6d3 7s2</li>
                    <li>Per shell: 2, 8, 18, 32, 32, 11, 2</li>
                </ul>
                <p><strong>Physical properties</strong></p>
                <ul>
                    <li>Phase: solid presumably</li>
                    <li>Melting point: Unknown</li>
                    <li>Boiling point: Unknown</li>
                </ul>
                <p><strong>History</strong></p>
                <ul>
                    <li>Naming: after Dubna, Moscow Oblast, Russia, site of the Joint Institute for Nuclear Research</li>
                    <li>Discovery: independently by the University of California and the Joint Institute for Nuclear Research (1970)</li>
                </ul>
            </div> 
        </div>
    </div>
