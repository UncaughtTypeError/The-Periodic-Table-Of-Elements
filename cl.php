...
<html>
    <head>
        <!-- Title -->
        <title>Chlorine (Cl) - The Periodic Table Of Elements</title>
    ...
    <div class="wrapper">
        <div class="wrapper-inner">
            <div class="card summary">
                ...
                <ul>
                    <li>Symbol: <sub>17</sub>Cl</li>
                    <li>Name: chlorine</li>
                    <li>Atomic number: 17</li>
                    <li>Atomic mass: 35.453 u ± 0.002 u</li>
                    <li>Boiling point: -34.04 °C</li>
                    <li>Electron configuration: 3s23p5</li>
                    <li>Electronegativity: 3.16</li>
                    <li>Discovered: 1774</li>
                    <li>Discoverer: Carl Wilhelm Scheele</li>
                </ul>   
            </div> 
            <div class="card description">
                ...
                <p>The most common compound of chlorine, sodium chloride (common salt), has been known since ancient times. Around 1630, chlorine gas was first synthesised in a chemical reaction, but not recognised as a fundamentally important substance. Carl Wilhelm Scheele wrote a description of chlorine gas in 1774, supposing it to be an oxide of a new element. In 1809, chemists suggested that the gas might be a pure element, and this was confirmed by Sir Humphry Davy in 1810, who named it from Ancient Greek: χλωρός khlôros "pale green" based on its colour.</p>
            </div> 
            <div class="card overview">
                <p><strong>General properties</strong></p>
                <ul>
                    <li>Appearance: pale yellow-green gas</li>
                    <li>Group: group 17 (halogens)</li>
                    <li>Block: p-block</li>
                    <li>Period: period 3</li>
                    <li>Element category: diatomic nonmetal</li>
                    <li>Electron configuration: 3s2 3p5</li>
                    <li>Per shell: 2, 8, 7</li>
                </ul>
                <p><strong>Physical properties</strong></p>
                <ul>
                    <li>Phase: gas</li>
                    <li>Melting point: 171.6 K ​(−101.5 °C, ​−150.7 °F)</li>
                    <li>Boiling point: 239.11 K ​(−34.04 °C, ​−29.27 °F)</li>
                </ul>
                <p><strong>History</strong></p>
                <ul>
                    <li>Discovery & First isolation: Carl Wilhelm Scheele (1774)</li>
                    <li>Recognized as an element by: Humphry Davy (1808)</li>
                </ul>
            </div> 
        </div>
    </div>
