...
<html>
    <head>
        <!-- Title -->
        <title>Polonium (Po) - The Periodic Table Of Elements</title>
        ...
        <link rel="canonical" href="https://periodictableofchemicalelements.com/polonium">

        <meta name="description" content="Polonium is a chemical element with symbol Po and atomic number 84. A rare and highly radioactive metal with no stable isotopes.">
        <meta name="robots" content="noindex,nofollow">
        <meta property="og:locale" content="en_GB">
        <meta property="og:type" content="website">
        <meta property="og:title" content="Polonium (Po) - The Periodic Table Of Elements">
        ...
        <div class="wrapper-inner">
            ...
            <div class="card overview">
                ...
                <ul>
                    ...
                    <li>Electron configuration: 4f14 5d10 6s2 6p4</li>
                    <li>Per shell: 2, 8, 18, 32, 18, 6</li>
                </ul>
                <p><strong>Physical properties</strong></p>
                <ul>
                    <li>Phase: solid</li>
                    <li>Melting point: 527 K ​(254 °C, ​489 °F)</li>
                    <li>Boiling point: 1235 K ​(962 °C, ​1764 °F)</li>
                </ul>
                <p><strong>History</strong></p>
                <ul>
                    <li>Naming: after Polonia, Latin for Poland, homeland of Marie Curie</li>
                    <li>Discovery: Pierre and Marie Curie (1898)</li>
                    <li>First isolation: Willy Marckwald (1902)</li>
                </ul>
            </div> 
        </div>
    </div>
