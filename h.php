...
<html>
    <head>
        <!-- Title -->
        <title>Hydrogen (H) - The Periodic Table Of Elements</title>
        ...
        <link rel="canonical" href="https://periodictableofchemicalelements.com/hydrogen">
        ...
        <div class="wrapper-inner">
            <div class="card summary">
                ...
                <ul>
                    ...
                    <li>Atomic mass: 1.00794 u ± 0.00001 u</li>
                    <li>Boiling point: -252.9 °C</li>
                    <li>Electron configuration: 1s1</li>
                    <li>Electronegativity: 2.2</li>
                    <li>Discovered: 1766</li>
                    <li>Discoverer: Henry Cavendish</li>
                </ul>   
            </div> 
            <div class="card description">
                <p>Hydrogen is a chemical element with chemical symbol H and atomic number 1. With an atomic weight of 1.00794 u, hydrogen is the lightest element on the periodic table.</p>
                <p>Its monatomic form (H) is the most abundant chemical substance in the Universe, constituting roughly 75% of all baryonic mass. Non-remnant stars are mainly composed of hydrogen in the plasma state. The most common isotope of hydrogen, termed protium (name rarely used, symbol 1H), has one proton and no neutrons.</p>
                <p>The universal emergence of atomic hydrogen first occurred during the recombination epoch. At standard temperature and pressure, hydrogen is a colorless, odorless, tasteless, non-toxic, nonmetallic, highly combustible diatomic gas with the molecular formula H2. Since hydrogen readily forms covalent compounds with most nonmetallic elements, most of the hydrogen on Earth exists in molecular forms such as water or organic compounds. </p>
            </div> 
            <div class="card overview">
                <p><strong>General properties</strong></p>
                <ul>
                    <li>Appearance: colorless gas</li>
                    <li>Group: group 1</li>
                    <li>Block: s-block</li>
                ...
                <ul>
                    ...
                    <li>Phase: gas</li>
                    <li>Melting point: 13.99 K ​(−259.16 °C, ​−434.49 °F)</li>
                    <li>Boiling point: 20.271 K ​(−252.879 °C, ​−423.182 °F)</li>
                </ul>
                
                <p><strong>History</strong></p>
                <ul>
                    <li>Discovery: Henry Cavendish (1766)</li>
                    <li>Named by: Antoine Lavoisier (1783)</li>
                </ul>
            </div> 
        </div>
    </div>
