...
<html>
    <head>
        <!-- Title -->
        <title>Mendelevium (Md) - The Periodic Table Of Elements</title>
        ...
        <link rel="canonical" href="https://periodictableofchemicalelements.com/mendelevium">

        <meta name="description" content="Mendelevium is a synthetic element with chemical symbol Md (formerly Mv) and atomic number 101. A metallic radioactive transuranic element in the actinide series.">
        <meta name="robots" content="noindex,nofollow">
        <meta property="og:locale" content="en_GB">
        <meta property="og:type" content="website">
        <meta property="og:title" content="Mendelevium (Md) - The Periodic Table Of Elements">
        ...
        <div class="wrapper-inner">
            ...
            <div class="card overview">
                ...
                <ul>
                    ...
                    <li>Electron configuration: 5f13 7s2</li>
                    <li>Per shell: 2, 8, 18, 32, 31, 8, 2</li>
                </ul>
                <p><strong>Physical properties</strong></p>
                <ul>
                    <li>Phase: solid presumably</li>
                    <li>Melting point: 1100 K ​(827 °C, ​1521 °F) (predicted)</li>
                    <li>Boiling point: Unknown</li>
                </ul>
                <p><strong>History</strong></p>
                <ul>
                    <li>Naming: after Dmitri Mendeleev</li>
                    <li>Discovery: Lawrence Berkeley National Laboratory (1955)</li>
                </ul>
            </div> 
        </div>
    </div>
