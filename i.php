...
<html>
    <head>
        <!-- Title -->
        <title>Iodine (I) - The Periodic Table Of Elements</title>
        ...
        <link rel="canonical" href="https://periodictableofchemicalelements.com/iodine">

        <meta name="description" content="Iodine is a chemical element with symbol I and atomic number 53. The heaviest of the stable halogens, it exists as a lustrous, purple-black metallic solid at a standard conditions that sublimes readily to form a violet gas.">
        <meta name="robots" content="noindex,nofollow">
        <meta property="og:locale" content="en_GB">
        <meta property="og:type" content="website">
        <meta property="og:title" content="Iodine (I) - The Periodic Table Of Elements">
    ...
    <div class="wrapper">
        <div class="wrapper-inner">
            <div class="card summary">
                ...
                <ul>
                    <li>Symbol: <sub>53</sub>I</li>
                    <li>Name: iodine</li>
                    <li>Atomic number: 53</li>
                    <li>Atomic mass: 126.90447 u</li>
                    <li>Boiling point: 184.3 °C</li>
                    <li>Electron configuration: 4d105s25p5</li>
                    <li>Electronegativity: 2.66</li>
                    <li>Discovered: 1811</li>
                    <li>Discoverer: Bernard Courtois</li>
                </ul>   
            </div> 
            <div class="card description">
                <p>Iodine is a chemical element with symbol I and atomic number 53. The heaviest of the stable halogens, it exists as a lustrous, purple-black metallic solid at a standard conditions that sublimes readily to form a violet gas. The elemental form was discovered by the French chemist Bernard Courtois in 1811. It was named two years later by Joseph-Louis Gay-Lussac from this property, after the Greek ἰωδης "violet-coloured".</p>
                ...
                <p>The dominant producers of iodine today are Chile and Japan. Iodine and its compounds are primarily used in nutrition.</p>
            </div> 
            <div class="card overview">
                <p><strong>General properties</strong></p>
                <ul>
                    <li>Appearance: lustrous metallic gray, violet as a gas</li>
                    <li>Group: group 17 (halogens)</li>
                    <li>Block: p-block</li>
                    <li>Period: period 5</li>
                    <li>Element category: diatomic nonmetal</li>
                    <li>Electron configuration: 4d10 5s2 5p5</li>
                    <li>Per shell: 2, 8, 18, 18, 7</li>
                </ul>
                <p><strong>Physical properties</strong></p>
                <ul>
                    <li>Phase: solid</li>
                    <li>Melting point: 386.85 K ​(113.7 °C, ​236.66 °F)</li>
                    <li>Boiling point: 457.4 K ​(184.3 °C, ​363.7 °F)</li>
                </ul>
                <p><strong>History</strong></p>
                <ul>
                    <li>Discovery & First isolation: Bernard Courtois (1811)</li>
                </ul>
            </div> 
        </div>
    </div>
