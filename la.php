...
<html>
    <head>
        <!-- Title -->
        <title>Lanthanum (La) - The Periodic Table Of Elements</title>
        ...
        <link rel="canonical" href="https://periodictableofchemicalelements.com/lanthanum">

        <meta name="description" content="Lanthanum is a soft, ductile, silvery-white metallic chemical element with symbol La and atomic number 57. It tarnishes rapidly when exposed to air and is soft enough to be cut with a knife.">
        <meta name="robots" content="noindex,nofollow">
        <meta property="og:locale" content="en_GB">
        <meta property="og:type" content="website">
        <meta property="og:title" content="Lanthanum (La) - The Periodic Table Of Elements">
        ...
        <div class="wrapper-inner">
            ...
            <div class="card overview">
                ...
                <ul>
                    ...
                    <li>Element category: lanthanide, sometimes considered a transition metal</li>
                    <li>Electron configuration: 5d1 6s2</li>
                    <li>Per shell: 2, 8, 18, 18, 9, 2</li>
                </ul>
                <p><strong>Physical properties</strong></p>
                <ul>
                    <li>Phase: solid</li>
                    <li>Melting point: 1193 K ​(920 °C, ​1688 °F)</li>
                    <li>Boiling point: 3737 K ​(3464 °C, ​6267 °F)</li>
                </ul>
                <p><strong>History</strong></p>
                <ul>
                    <li>Discovery: Carl Gustaf Mosander (1839)</li>
                </ul>
            </div> 
        </div>
    </div>
