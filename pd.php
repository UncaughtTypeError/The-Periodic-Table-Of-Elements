...
<html>
    <head>
        <!-- Title -->
        <title>Palladium (Pd) - The Periodic Table Of Elements</title>
        ...
        <link rel="canonical" href="https://periodictableofchemicalelements.com/palladium">

        <meta name="description" content="Palladium is a chemical element with symbol Pd and atomic number 46. It is a rare and lustrous silvery-white metal discovered in 1803 by William Hyde Wollaston.">
        <meta name="robots" content="noindex,nofollow">
        <meta property="og:locale" content="en_GB">
        <meta property="og:type" content="website">
        <meta property="og:title" content="Palladium (Pd) - The Periodic Table Of Elements">
    ...
    <div class="wrapper threat-limited">
        <div class="wrapper-inner">
            <div class="card summary">
                ...
                <ul>
                    <li>Symbol: <sub>46</sub>Pd</li>
                    <li>Name: palladium</li>
                    <li>Atomic number: 46</li>
                    <li>Atomic mass: 106.42 u ± 0.01 u</li>
                    <li>Boiling point: 2963 °C</li>
                    <li>Electron configuration: 4d10</li>
                    <li>Electronegativity: 2.20</li>
                    <li>Discovered: 1803</li>
                    <li>Discoverer: William Hyde Wollaston</li>
                </ul>    
            ...
            <div class="card description">
                <p>Palladium is a chemical element with symbol Pd and atomic number 46. It is a rare and lustrous silvery-white metal discovered in 1803 by William Hyde Wollaston. He named it after the asteroid Pallas, which was itself named after the epithet of the Greek goddess Athena, acquired by her when she slew Pallas. Palladium, platinum, rhodium, ruthenium, iridium and osmium form a group of elements referred to as the platinum group metals (PGMs). These have similar chemical properties, but palladium has the lowest melting point and is the least dense of them.</p>
                <p>More than half the supply of palladium and its congener platinum is used in catalytic converters, which convert as much as 90% of the harmful gases in automobile exhaust (hydrocarbons, carbon monoxide, and nitrogen dioxide) into less noxious substances (nitrogen, carbon dioxide and water vapor). Palladium is also used in electronics, dentistry, medicine, hydrogen purification, chemical applications, groundwater treatment, and jewelry. Palladium is a key component of fuel cells, which react hydrogen with oxygen to produce electricity, heat, and water.</p>
            </div> 
            <div class="card overview">
                ...
                <ul>
                    ...
                    <li>Electron configuration: 4d10</li>
                    <li>Per shell: 2, 8, 18, 18</li>
                </ul>
                <p><strong>Physical properties</strong></p>
                <ul>
                    <li>Phase: solid</li>
                    <li>Melting point: 1828.05 K ​(1554.9 °C, ​2830.82 °F)</li>
                    <li>Boiling point: 3236 K ​(2963 °C, ​5365 °F)</li>
                </ul>
                <p><strong>History</strong></p>
                <ul>
                    <li>Naming: after asteroid Pallas, itself named after Pallas Athena</li>
                    <li>Discovery & First isolation: William Hyde Wollaston (1803)</li>
                </ul>
            </div> 
        </div>
    </div>
