...
<!--<![endif]--><!-- BEGIN head -->
    <head>
        <!-- Title -->
        <title>Lawrencium - The Periodic Table Of Elements</title>
        ...
        <link rel="canonical" href="https://periodictableofchemicalelements.com/lawrencium">

        <meta name="description" content="Lawrencium is a synthetic chemical element with chemical symbol Lr (formerly Lw) and atomic number 103. It is named in honor of Ernest Lawrence, inventor of the cyclotron, a device that was used to discover many artificial radioactive elements.">
        <meta name="robots" content="noindex,nofollow">
        <meta property="og:locale" content="en_GB">
        <meta property="og:type" content="website">
        <meta property="og:title" content="Lawrencium - The Periodic Table Of Elements">
        ...
        <div class="wrapper-inner">
            ...
            <div class="card overview">
                ...
                <ul>
                    ...
                    <li>Element category: actinide, sometimes considered a transition metal</li>
                    <li>Electron configuration: 5f14 7s2 7p1</li>
                    <li>Per shell: 2, 8, 18, 32, 32, 8, 3</li>
                </ul>
                <p><strong>Physical properties</strong></p>
                <ul>
                    <li>Phase: solid (predicted)</li>
                    <li>Melting point: 1900 K ​(1627 °C, ​2961 °F) (predicted)</li>
                    <li>Boiling point: Unknown</li>
                </ul>
                <p><strong>History</strong></p>
                <ul>
                    <li>Naming: after Ernest Lawrence</li>
                    <li>Discovery: Lawrence Berkeley National Laboratory and Joint Institute for Nuclear Research (1961–1971)</li>
                </ul>
            </div> 
        </div>
    </div>
